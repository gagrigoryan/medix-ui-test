...
const ChevronLeftIcon: React.FC<IconProps> = ({ size = EIconSize.Normal, className }) => (
  <i className={clsx(getIconClassName(size), className)}>
    ...
    >
      <path d="M19 10L13 16L19 22" stroke="#121232" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  </i>
);
